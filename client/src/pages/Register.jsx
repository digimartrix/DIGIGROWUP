...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8 lg:p-12 xl:p-14 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-rose-100/50 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-sky-100/60 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-6xl xl:max-w-7xl min-h-[660px] bg-white border border-slate-200/90 rounded-3xl shadow-2xl shadow-slate-200/60 overflow-hidden flex flex-col lg:flex-row relative z-10">
        ...
        <div className="w-full lg:w-[48%] xl:w-[50%] p-8 lg:p-12 xl:p-16 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col justify-between gap-8 bg-slate-50/70">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="font-mono text-slate-600 text-[10px] tracking-wider mt-1 font-bold">ECOSYSTEM MEMBERSHIP</span>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center my-2 group">
            ...
            <button
              ...
              className="cursor-pointer mb-4 px-5 py-3 rounded-2xl bg-white border border-slate-200 text-slate-800 text-xs md:text-sm font-bold shadow-xs hover:shadow-md hover:border-[#EA4532]/40 transition-all flex items-center gap-2.5 max-w-sm text-center"
            >
              <span>{THOUGHTS[thoughtIdx]}</span>
              <Volume2 size={16} className="text-[#EA4532] flex-shrink-0 animate-pulse" />
            </button>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-2 text-xs font-bold text-slate-800">
                  <Icon size={15} className="text-[#EA4532]" />
                  <span>{label}</span>
                </div>
        ...
        <div className="flex-1 p-8 lg:p-12 xl:p-16 flex flex-col justify-center bg-white">
          <div className="w-full max-w-lg mx-auto page-enter">
            ...
            <div className="mb-6">
              <h2 className="text-2xl lg:text-3xl font-heading font-black text-slate-900 tracking-tight">Create Account</h2>
                  ...
                  {ROLE_OPTIONS.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-xs xl:text-sm font-heading font-bold">{r.title}</p>
